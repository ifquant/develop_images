docker run --name dev.lang.wine.test -itd --privileged=true  -v /dev:/dev  -v /home/dev/nlp:/home/dev/code -v /tmp/.X11-unix:/tmp/.X11-unix -v /var/run/dbus:/var/run/dbus -v /run/systemd:/run/systemd -v /usr/bin/systemctl:/usr/bin/systemctl -v /etc/systemd/system:/etc/systemd/system -e DISPLAY=unix$DISPLAY   -e GDK_SCALE   -e GDK_DPI_SCALE  base:dev.lang.wine.test /bin/bash
