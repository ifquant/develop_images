...
- Added samples:
  - Step by step [sample script](https://github.com/yousefvand/shellman/blob/master/samples/backup-tool) tutorial.
...
- Animation
  ...
  - Call `animate` function. Check [sample animations](https://github.com/yousefvand/shellman/blob/master/samples/animation/funny-cat.sh).
  - pacman animation for texts. Check [sample animations](https://github.com/yousefvand/shellman/blob/master/samples/animation/pacman.sh).
- String
