...
* Run Source(`Ctrl+Shift+S` or Push icon![icon](https://github.com/Ikuyadeu/vscode-R/raw/master/images/FileDownload.png)) and Run Selected Line (`Ctrl+Enter`) (Mac: `Ctrl` to `⌘`)
* Run functions:
...
![RStudio addin launcher](https://github.com/Ikuyadeu/vscode-R/raw/master/images/vscode_addins.png)
...
![Attached R process](https://github.com/Ikuyadeu/vscode-R/raw/master/./images/RStatusBarItem.png)
